...
<template>
    <el-row class="co-header flex bg-white">
        <el-col :span="5" class="header-logo flex flex-align-center">
            ...
            <span class="pl8 ellipsis">test-sdk</span>
        </el-col>
        <el-col :span="19" class="header-nav flex flex-justify-end flex-align-center">
            ...
            <a href="https://git.souche-inc.com/wangriqiao/test-sdk" target="_blank">
...
export default {
    ...
    methods: {
        goVersion(tag) {
            window.open(`https://fedoc.souche-inc.com/test-sdk/${tag}/index.html`, '_blank');
        }
    },
    computed: {
        activeIndex() {
